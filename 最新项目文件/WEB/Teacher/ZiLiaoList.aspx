<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZiLiaoList.aspx.cs" Inherits="BaseSystem.Teacher_ZiLiaoList" %>
...
<head runat="server">
    ...
    <script src="../JS/Teachers/ZiLiao.js" type="text/javascript"></script>
</head>
<body>
...
<div id="div_zhiri">
    ...
    <div class="clear"></div>
    <div id="div_main">
    <asp:HiddenField ID="HidMenuName" Value="资料管理" runat="server" />
    <div class="datagrid">
        <div class="datagrid-header2">
                ...
                <tr>
                    <td class="query">
                        ...
                        <asp:DropDownList ID="ddlFilter" runat="server" AutoPostBack="True" 
                            ...
                            <asp:ListItem>我的上传</asp:ListItem>
                    ...
                    <td class="operating">
                        ...
                        <a href="#" class="btn btn-toolbar" onclick="ZiLiaoDel(<%=Pager.PageIndex.ToString() %>)" id="btnDel" ><i class="icon icon-delete"></i>删除</a>
                    </td>
                </tr>
            </table>
            ...
            <table class="datagrid-head-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                     <% if (ddlFilter.SelectedValue=="我的上传")
                     {
                     %>
                     ...
                     %>
                    <th width="25%"><b>资料名称</b></th>
                    <th width="12%"><b>上传者</b></th>
                    <th width="12%"><b>上传日期</b></th>
                    <th width="5%"><b>下载次数</b></th>
                    <th width="5%"><b>下载</b></th>
                    <% if (ddlFilter.SelectedValue=="我的上传")
                     {
                     %>
                         <th width="10%">是否可见</th>                    
              ...
              <asp:Repeater ID="rpt_stu" runat="server">
                ...
                <tr>
                    ...
                    <% 
                     ...
                     %>
                    <td width="25%"> <a href="<%#Eval("ZLPATH") %>"><%#Eval("ZLNAME") %></a> </td>
                    <td width="12%"><%#Eval("NAME")%><%#Eval("FLAG").ToString().Trim()=="0"?"老师":"同学"%></td>
                    <td width="12%"><%#Eval("SCSJ")%>&nbsp;</td>
                    <td width="5%"><%#Eval("XZCS")%>&nbsp;</td>
                    <td width="5%"><a href="<%#Eval("ZLPATH") %>">下载</a></td>
                    <% if (ddlFilter.SelectedValue=="我的上传")
                     {
                     %>
                         <td width="10%"><%#Eval("STATE").ToString().Trim()=="0"?"可见":"不可见"%>&nbsp;</td>               
                     <% 
                     }
                     %>
