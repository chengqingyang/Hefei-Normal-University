<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DaYiList.aspx.cs" Inherits="BaseSystem.Teacher_DaYiList" %>
        ...
        <div class="datagrid-header2">
            <table class="datagrid-control-table" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="operating">
                        <a href="#" class="btn btn-toolbar" onclick="GoEdit(<%=Pager.PageIndex.ToString() %>)" id="btnEdit" ><i class="icon icon-edit"></i>回复</a>
                    </td>
                </tr>
            </table>
            ...
            <table class="datagrid-main-table" width="100%" border="0" cellpadding="0" cellspacing="0">
              <asp:Repeater ID="rpt_stu" runat="server">
                ...
                <tr>
                    ...
                    <td width="5%"><%#Eval("NAME")%></td>
                    <td width="12%"><%#Eval("TWSJ")%>&nbsp;</td>
                    <td width="5%"><%#Eval("CLICK")%>&nbsp;</td>
                    <td width="5%"><%#Eval("STATE").ToString().Trim()=="0"?"<b>未回复</b>":"<i>已回复</i>"%>&nbsp;</td>
