<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TiaoKeList.aspx.cs" Inherits="BaseSystem.Teacher_TiaoKeList" %>
...
<div id="div_zhiri">
    <div id="div_top">
        ...
        <div class="top_right">教师调课管理</div>        
            ...
            <div class="datagrid-head-line"></div>
                <table class="datagrid-head-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <th width="10%"><b>调课班级</b></th>
                        <th width="10%"><b>调课日期</b></th>
                        <th width="25%"><b>调课正文</b></th>
                ...
                <table class="datagrid-main-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                  <asp:Repeater ID="rpt_stu" runat="server">
                    ...
                    <tr>
                        ...
                        <td width="5%"><%#Eval("TKNO") %>&nbsp;</td>
                        <td width="10%"><%#Eval("XNNAME")%>&nbsp;</td>
                        <td width="10%"><%#Eval("XQNAME")%>&nbsp;</td>
                        <td width="10%"><%#Eval("CLASSNAME")%>&nbsp;</td>
                        <td width="10%"><%#Eval("TKRQ")%>&nbsp;</td>
                        <td width="25%"><%#Eval("TKZW")%>&nbsp;</td>
                        <td width="5%">
                            <a href="TiaoKeList.aspx?st=<%#Eval("STATE")%>&lsh=<%#Eval("LSH") %>">
