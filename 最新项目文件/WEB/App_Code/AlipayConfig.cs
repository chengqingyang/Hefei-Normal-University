...
namespace Com.Alipay
{
    ...
    internal class Config
    {
        ...
        static Config()
        {
            ...
            partner = "2088411058403305";

            //交易安全检验码，由数字和字母组成的32位字符串
            key = "to6fd3tl99ilpat1qa0lo87offtxfhbc";

            //签约支付宝账号或卖家支付宝帐户
            seller_email = "maiwo@maiwo.la";

            //页面跳转同步返回页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            return_url = "http://www.maiwo.la/Pay/return_url.aspx";

            //服务器通知的页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            notify_url = "http://www.maiwo.la/Pay/notify_url.aspx";
