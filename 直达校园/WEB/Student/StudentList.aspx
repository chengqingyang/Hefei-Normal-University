<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentList.aspx.cs" Inherits="BaseSystem.Student_StudentList" %>
...
<head runat="server">
    ...
    <script src="../JS/Students/Student.js" type="text/javascript"></script>
    
</head>
<body>
    <form id="form1" runat="server">
    <asp:HiddenField ID="HidMenuName" Value="学生管理" runat="server" />
    <div class="datagrid">
            ...
            <table class="datagrid-control-table" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="query">
        	            学号：<input id="loginName" type="text" class="ddt-input ddt-input-l" style="width:150px" runat="server" />
                    ...
                    <td class="operating">
                        ...
                        <a href="#" class="btn btn-toolbar" onclick="StudentDel(<%=Pager.PageIndex.ToString() %>)" id="btnDel" ><i class="icon icon-delete"></i>删除</a>
                        <a href="../Teacher/ImPortEXCEL/ImportStudentEXCEL.aspx" class="btn btn-toolbar" id="A1" ><i class="icon icon-add"></i>学生信息导入</a>
                    </td>
                </tr>
            </table>
            ...
            <table class="datagrid-main-table" width="100%" border="0" cellpadding="0" cellspacing="0">
              <asp:Repeater ID="rpt_stu" runat="server">
                ...
                <tr>
                    ...
                    <td width="5%"><img src="<%#Eval("ZPPATH") %>" alt="" width="32" height="32" /></td>
                    <td width="8%"><%#Eval("SNO") %>&nbsp;</td>
