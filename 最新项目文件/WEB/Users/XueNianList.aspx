<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XueNianList.aspx.cs" Inherits="BaseSystem.Users_XueNianList" %>
...
<div id="div_zhiri">
    <div id="div_top">
        ...
        <div class="top_right">学年信息维护</div>        
    ...
    <div class="clear"></div>
    <div id="div_main">
        <asp:HiddenField ID="HidMenuName" Value="学年管理" runat="server" />
        <div class="datagrid">
                    ...
                    <tr>
                        <td class="query">
                            ...
                            <asp:DropDownList ID="ddlQuery" runat="server">
                                <asp:ListItem Value="B.SCHOOLNAME">所在学校</asp:ListItem>
                                <asp:ListItem Value="XNNAME">学年名称</asp:ListItem>
                        ...
                        <td class="operating">
                            ...
                            <a href="#" class="btn btn-toolbar" onclick="XueNianDel(<%=Pager.PageIndex.ToString() %>)" id="btnDel" ><i class="icon icon-delete"></i>删除</a>
                        </td>
                    </tr>
                </table>
                ...
                <table class="datagrid-main-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                  <asp:Repeater ID="rpt_xuenian" runat="server">
                    ...
                    <tr>
                        ...
                        <td width="5%">
                            <a href="XueNianList.aspx?st=<%#Eval("STATE")%>&lsh=<%#Eval("LSH") %>">
                                <%#Eval("STATE").ToString()=="0"?"可用":"不可用"%>&nbsp;
                            </a>
                        </td>
                        <td width="5%">
                            <a href="XueNianList.aspx?sort=<%#Eval("SORT")%>&lsh=<%#Eval("LSH")%>&sw=up">↑</a>
                            &nbsp;<%#Eval("SORT")%>&nbsp;
                            <a href="XueNianList.aspx?sort=<%#Eval("SORT")%>&lsh=<%#Eval("LSH")%>&sw=down">↓</a>
                        </td>
