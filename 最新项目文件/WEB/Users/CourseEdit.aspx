<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseEdit.aspx.cs" Inherits="BaseSystem.Users_CourseEdit" %>
        ...
        <div class="datagrid-header">
            <table class="datagrid-control-table" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="operating">
                        <a href="#" onclick="CourseSave()" class="btn btn-toolbar"><span class="icon icon-save">
        ...
        <div class="datadetail-view">
            <table class="datadetail-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input id="txtcoursename" style="width: 200px" class="ddt-input ddt-input-l" maxlength="20"
