...
tabMenu.prototype={
 initialize:function(container,selfOpt,otherOpt){
  this.container=$(container);
    var selfOptions=Object.extend({fontWeight:"bold",fontSize:"12px",color:"#228804"},selfOpt||{});
...
var tab1=new tabMenu("tab_container1",{fontSize:"12px",color:"#228804",fontWeight:"bold"},{fontWeight:"normal",color:"#666"});// -->
