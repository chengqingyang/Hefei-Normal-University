...
<body bgColor='#ffffff'>
  ...
  <tr>
    <td width='20%' height="60"><div style="font-family:宋体; color:#FFFFFF; filter:Glow(Color=#000000,Strength=2); WIDTH: 100%; FONT-WEIGHT: bold; FONT-SIZE: 19pt; margin-top:5pt">
      <div align="center" class="STYLE5 STYLE1">直达校园</div>
    </div></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<strong class="username" style="color:Red"><%=  Session["truename"].ToString().Trim()%></strong> 学校：<strong style="color:Red;"><%=Session["schoolname"].ToString().Trim()%></strong> 您的权限：<strong style="color:Red;"><%= Session["cx"].ToString().Trim() %></strong>,欢迎使用直达校园平台！
        	
        	[<a href="logout.aspx" target="_top" style="color:Red">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
