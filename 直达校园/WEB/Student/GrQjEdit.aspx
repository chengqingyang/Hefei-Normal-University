<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GrQjEdit.aspx.cs" Inherits="BaseSystem.Users_SchoolEdit" %>
...
<body>
    ...
    <asp:HiddenField ID="hiddqzt" runat="server" />
        ...
        <div class="datagrid-header">
            <table class="datagrid-control-table" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="operating">
                        <a href="#" onclick="QjtSave()" class="btn btn-toolbar"><span class="icon icon-save">
                        </span>保存</a>
                        <a href="#" onclick="TjshSave()" class="btn btn-toolbar"><span class="icon icon-save">
                        </span>提交审核</a>
        ...
        <div class="datadetail-view">
            <table class="datadetail-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <input id="txtQjjs" style="width: 427px" class="ddt-input ddt-input-l" maxlength="20"
                ...
                <tr>
                    ...
                    <td>
                        <input id="txtXsqz" style="width: 200px" maxlength="20" class="ddt-input ddt-input-l"
                            type="text" runat="server" />
                             审批状态：<asp:Label runat="server" ID="labSpzt" ForeColor="red"></asp:Label>
                    </td>
