<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DaYiEdit.aspx.cs" Inherits="BaseSystem.Student_DaYiEdit" %>
...
<div id="div_zhiri">
    ...
    <input type="hidden" runat="Server" id="txtanswer" />
        ...
        <div class="datadetail-view">
            <table class="datadetail-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input id="txttitle" type="text" runat="Server" style="width:520px; height:24px;" />
                    </td>
                    <td> </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="txtcontent" type="text" runat="Server" style="width:520px; height:220px;" />
                    </td>
                    <td> </td>
                </tr>
            </table>
