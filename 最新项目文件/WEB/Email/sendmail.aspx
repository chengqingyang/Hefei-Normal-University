    ...
    <form id="form1" runat="server">
        <div style="width: 100%">
            <div>
                ...
                <asp:Button ID="btn_caogao" runat="server" Text="存入草稿箱" OnClick="btn_caogao_Click"  />
            </div>
            <br style="line-height: 10px" />
            <div>
                <table style="width: 100%; border: none">
                    <tr>
                        <td style="border-style: none; border-color: inherit; border-width: medium;" class="auto-style3">
                            发给</td>
                        <td style="border: none" class="auto-style4">
