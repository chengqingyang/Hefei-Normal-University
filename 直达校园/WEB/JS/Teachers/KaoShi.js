...
function GoEdit(pageindex) {
    ...
    location.href = "KaoShiEdit.aspx?getid=" + arr[0] + "&page=" + pageindex;
}
...
//alert(keyvalue);
    ...
    $.ajax({
        type: "POST",
        url: "../Handler/Teacher/KaoShiHandler.ashx?action=ksdel&keyvalue=" + escape(keyvalue),
