...
<body>
    <form id="form1" runat="server">
        <div style="width: 100%">
            <div>
                <asp:Button ID="btn_del" runat="server" Text="删  除" OnClick="btn_del_Click" /><asp:Button
                    ID="btn_del1" runat="server" Text="彻底删除" OnClick="btn_del1_Click" /><asp:Button ID="btn_ref" runat="server"
                        Text="刷  新" />
        ...
        <table id="tab_mails" runat="server" style="width: 100%">
            <tr class="tabTitle">
                ...
                <td style="width: 15%; height: 16px; text-align: center;">
                    收件人</td>
                <td style="height: 16px;width: 20%; text-align: center">
                    主题</td>
