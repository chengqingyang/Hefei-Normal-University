<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XueQiEdit.aspx.cs" Inherits="BaseSystem.Users_XueQiEdit" %>
            ...
            <div class="datagrid-header2">
                <table class="datagrid-control-table" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="operating">
                            <a href="#" onclick="XueQiSave()" class="btn btn-toolbar">
            ...
            <div class="datadetail-view">
                <table class="datadetail-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlXueNian" runat="server" class="ddt-input ddt-input-l" 
                                Width="208px" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                    </tr> 
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlState" runat="server" class="ddt-input ddt-input-l" 
                                Width="208px" >
                        ...
                        <td>
                            <input id="txtxueqino" style="width: 200px" class="ddt-input ddt-input-l" 
                                maxlength="20" type="text" runat="server" disabled="disabled" />
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input id="txtxueqiname" style="width: 200px" class="ddt-input ddt-input-l" 
