<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherEdit.aspx.cs" Inherits="BaseSystem.Teacher_TeacherEdit" %>
...
<head runat="server">
    ...
    <script src="../JS/Teachers/TeacherEdit.js" type="text/javascript"></script>
            ...
            <table class="datagrid-control-table" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="operating" style="width:90%">
                        <a href="#" onclick="TeacherSave()" class="btn btn-toolbar"><span class="icon icon-save">
                        </span>保存</a> 
                    </td>
                    <td>
            ...
            <div class="div_out">
                <div class="div_left">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="txtname" style="width: 200px" class="ddt-input ddt-input-l" maxlength="20"
                                runat="server" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>                       
                            <input id="txtbirth" style="width: 200px" class="ddt-input ddt-input-l" maxlength="60"
                                type="text" runat="server" onclick="calendar(this)" />
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlSchool" runat="server" Width="208px" 
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="txtzc" class="ddt-input ddt-input-l" style="width: 200px"
                                runat="server" />
                        </td>
                    </tr>
                    <tr>
