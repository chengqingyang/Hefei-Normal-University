<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseList.aspx.cs" Inherits="BaseSystem.Users_CourseList" %>
...
<head runat="server">
    ...
    <script src="../JS/Users/Course.js" type="text/javascript"></script>
    
</head>
<body>
    <form id="form1" runat="server">
    <asp:HiddenField ID="HidMenuName" Value="课程管理" runat="server" />
    <div class="datagrid">
                ...
                <tr>
                    <td class="query">
                        ...
                        <asp:DropDownList ID="ddlQuery" runat="server">
                            ...
                            <asp:ListItem Value="COURSENO">课程编号</asp:ListItem>
                            <asp:ListItem Value="DJRYGH">登记人</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td class="operating">
                        ...
                        <a href="#" class="btn btn-toolbar" onclick="CourseDel(<%=Pager.PageIndex.ToString() %>)" id="btnDel" ><i class="icon icon-delete"></i>删除</a>
                    </td>
                </tr>
            </table>
