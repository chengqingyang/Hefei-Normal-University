<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GrQjlList.aspx.cs" Inherits="BaseSystem.Users_SchoolList" %>
...
<body>
    ...
    <asp:HiddenField ID="HidMenuName" Value="学生请假" runat="server" />
    <div class="datagrid">
                ...
                <tr>
                    <td class="query">
                        ...
                        <asp:DropDownList ID="ddlQuery" runat="server">
                            ...
                            <asp:ListItem Value="SCHOOLNO">学号</asp:ListItem>
                            <asp:ListItem Value="SCHOOLNAME">姓名</asp:ListItem>
                            <asp:ListItem Value="XZNAME">审批状态</asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <td class="operating">
                        <a href="#" class="btn btn-toolbar" onclick="GoAdd(<%=Pager.PageIndex.ToString() %>)" id="btnAdd" ><i class="icon icon-add"></i>我要请假</a>
                        <a href="#" class="btn btn-toolbar" onclick="GoEdit(<%=Pager.PageIndex.ToString() %>)" id="btnEdit" ><i class="icon icon-edit"></i>修改请假条</a>
                        <a href="#" class="btn btn-toolbar" onclick="XSqjDel(<%=Pager.PageIndex.ToString() %>)" id="btnDel" ><i class="icon icon-delete"></i>删除请假条</a>
                    </td>
                </tr>
            </table>
            ...
            <table class="datagrid-head-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <th width="20%"><b>请假主题</b></th>
                    <th width="20%"><b>请假时间</b></th>
            ...
            <table class="datagrid-main-table" width="100%" border="0" cellpadding="0" cellspacing="0">
              <asp:Repeater ID="rpt_user" runat="server">
                ...
                <tr>
                    ...
                    <td width="20%"><%#Eval("QJZT")%>&nbsp;</td>
                    <td width="20%"><%#Eval("QJSJ")%>&nbsp;</td>
                    <td width="10%"><%#Eval("DQZT")%>&nbsp;</td>
                    <td width="10%"> 
                    <a href="GrQjEdit.aspx?getid=<%#Eval("LSH") %>&page=<%=Pager.PageIndex.ToString() %>"
                           title="查看详情">
                     <span style="color:Red;">查看请假条</span>
                    </td>
                </tr>
                </ItemTemplate>
                </asp:Repeater>
