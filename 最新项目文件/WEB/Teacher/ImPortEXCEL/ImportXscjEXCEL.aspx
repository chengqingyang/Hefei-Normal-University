<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportXscjEXCEL.aspx.cs" Inherits="ImportUsers" %>
        ...
        <table style="width: 90%"> 
            <tr> 
                <td style="width: 159px" colspan=2> 
                    <strong><span style="font-size: 10pt">学生成绩EXCEL文件导入</span></strong></td> 
            </tr> 
            <tr> 
