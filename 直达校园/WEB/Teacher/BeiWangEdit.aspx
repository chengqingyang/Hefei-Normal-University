<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BeiWangEdit.aspx.cs" Inherits="BaseSystem.Teacher_BeiWangEdit" %>
...
<head runat="server">
    ...
    <script src="../JS/Teachers/BeiWangEdit.js" type="text/javascript"></script>
...
<body>
    ...
    <input type="hidden" id="hidtype" value="<%=Session["cx"].ToString() %>">
        ...
        <div class="datagrid-header">
            <table class="datagrid-control-table" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="operating">
                        <a href="#" onclick="BeiWangSave()" class="btn btn-toolbar"><span class="icon icon-save">
                        </span>保存</a> 
        ...
        <div class="datadetail-view">
            <table class="datadetail-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td >
                        <input id="txttitle" style="width: 500px" class="ddt-input ddt-input-l" maxlength="100"
                ...
                <tr>
                    ...
                    <td>
                        <input id="txtdate" style="width: 500px" class="ddt-input ddt-input-l" maxlength="50"
                ...
                <tr>
                    ...
                    <td>
                        <input id="txtbody"  maxlength="200"  style="width: 500px; height: 220px;" 
