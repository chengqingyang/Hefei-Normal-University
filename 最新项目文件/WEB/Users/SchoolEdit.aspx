<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolEdit.aspx.cs" Inherits="BaseSystem.Users_SchoolEdit" %>
        ...
        <div class="datagrid-header">
            <table class="datagrid-control-table" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="operating">
                        <a href="#" onclick="SchoolSave()" class="btn btn-toolbar"><span class="icon icon-save">
        ...
        <div class="datadetail-view">
            <table class="datadetail-table" width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <input id="txtschoolname" style="width: 200px" class="ddt-input ddt-input-l" maxlength="20"
                ...
                <tr>
                    ...
                    <td>
                        <input id="txtxzname" style="width: 200px" class="ddt-input ddt-input-l" maxlength="20"
                            type="text" runat="server" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="txtschooladdr" style="width: 200px" maxlength="20" class="ddt-input ddt-input-l"
                            type="text" runat="server" />
                    </td>
                </tr>     
                <tr>
