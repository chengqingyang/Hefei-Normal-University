...
function GoEdit(pageindex) {
    ...
    location.href = "TeacherEdit.aspx?getid=" + arr[0] + "&page=" + pageindex;
}
...
function TeacherDel(pageindex) {
    ...
    $.ajax({
        type: "POST",
        url: "../Handler/Teacher/TeacherHandler.ashx?action=tcdel&keyvalue=" + escape(keyvalue),
